...
public class App_treeSetObjetosPropios3 {
	public static void main(String[] args) {
		System.out.println("*****TREESET******");

		Set<Usuario> usuarios = new TreeSet<Usuario>(new UsuarioOrdenClave());
...
class UsuarioOrdenClave implements Comparator<Usuario> {
