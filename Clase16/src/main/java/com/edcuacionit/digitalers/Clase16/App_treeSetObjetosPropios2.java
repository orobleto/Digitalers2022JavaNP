...
import com.edcuacionit.digitalers.comparadores.UsuarioOrdenCorreo;
...
public class App_treeSetObjetosPropios2 {
	public static void main(String[] args) {
		System.out.println("*****TREESET******");

		UsuarioOrdenCorreo usuarioOrdenCorreo = new UsuarioOrdenCorreo();
		Set<Usuario> usuarios = new TreeSet<Usuario>(usuarioOrdenCorreo);
